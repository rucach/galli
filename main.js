...
document.getElementById("sketch_to_be_drawn").innerHTML = '<p id="sketch_to_be_drawn">Sketch to be drawn: ' + Element_of_array + '</p>';
...
function draw(){
    function check_sketch(){
        ...
        document.getElementById("time").innerHTML = '<span id="time">Timer: ' + timer_counter + '</span>';
    ...
    if(Element_of_array == drawn_sketch){
        score = score + 1;
        document.getElementById("points").innerHTML = '<span id="points">Score: ' + score + '</span>';
    }
}